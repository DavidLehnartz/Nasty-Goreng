...
// Header Template
function getHeaderImpressumTemplate() {
    return `
        <header class="div">
...
// Hero Template
function getHeroImpressumTemplate() {
    return `
            <div class="slider">
                <h1>
                    Nasty Goreng
...
function getImpressumTemplate() {
    return `
            ...
            <p><strong>Haftungsausschluss: </strong><br><br><strong>Haftung für Inhalte</strong><br><br>
                ...
                Weise und zu dem zuvor benannten Zweck einverstanden.<br><br><strong>Google AdSense</strong><br><br>
...
// Footer Template
function getFooterImpressumTemplate() {
    return `
               <footer>
                  <b>Selamat makan</b>
                  <div>
                   ...
                   <div class="data-policy-wrapper">
                     ...
                     <a class="data-policy" href="privavy.html">
                      Privacy 
                      </a>
                   </div>
               </footer>
